...
public class MenuUtils {
    ...
    public static void printOptionsMain() {
        ...
        System.out.println(Color.GREEN.getCode() + "If you select search with login, you will be provided with these options: \n" +
                "- Search \n" +
                "- Search history \n" + Color.RESET.getCode());
        System.out.println(Color.GREEN.getCode() + "If you select search without login, you will be provided with these options: \n" +
                "- Search \n" + Color.RESET.getCode());
        System.out.print(Color.YELLOW.getCode() + "Enter your choice (1-4): " + Color.RESET.getCode());
    }

    public static void printOptionsLoginMenu() {
        System.out.println(Color.MAGENTA.getCode() + "Login Menu:" + Color.RESET.getCode());
        System.out.println(Color.MAGENTA.getCode() + "1. Login" + Color.RESET.getCode());
        System.out.println(Color.MAGENTA.getCode() + "2. Return to Main Menu \n" + Color.RESET.getCode());
        System.out.print(Color.YELLOW.getCode() + "Enter your choice (1-2): " + Color.RESET.getCode());
    }

    public static void printOptionsSubMenuTwo() {
        System.out.println(Color.MAGENTA.getCode() + "Search without login" + Color.RESET.getCode());
        System.out.println(Color.MAGENTA.getCode() + "1. Search" + Color.RESET.getCode());
        System.out.println(Color.MAGENTA.getCode() + "2. Return to Main Menu \n" + Color.RESET.getCode());
    ...
    public static void printOptionsSubMenuOne() {
        System.out.println(Color.MAGENTA.getCode() + "Search with login:" + Color.RESET.getCode());
        System.out.println(Color.MAGENTA.getCode() + "1. Search" + Color.RESET.getCode());
        System.out.println(Color.MAGENTA.getCode() + "2. Show search history" + Color.RESET.getCode());
        System.out.println(Color.MAGENTA.getCode() + "3. Return to Login Menu \n" + Color.RESET.getCode());
